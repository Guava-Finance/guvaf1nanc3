      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            title: Text(
              'Pay Anyone - Start a Bank Transfer',
                            ...
                            CustomListPicker(
                              ...
                              onTap: (p0) {
                                ...
                                final bank = data!.firstWhere((e) =>
                                    e.name.toLowerCase() == p0.toLowerCase());

                                tn.accountResolutionData['bank'] = bank.code;
          ...
          Visibility(
            visible: (num.tryParse(amountCtrl.text)?.toDouble() ?? 0.0) > 1,
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                10.verticalSpace,
